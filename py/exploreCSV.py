...
#####>-
##
##  Description : Example of CSV import, edit, save 
##
...
indexes = range(len(df.iloc[:,0]))
df.set_value(46,'GDPpc', 9999)

df.to_csv(r"C:\Users\cgistest3\Desktop\materials\DSS-IntroProgResearch-20180316\output\OECD-gdp2.csv",sep=',')
